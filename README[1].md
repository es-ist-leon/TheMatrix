...
Falls Java nicht installiert ist, kannst du es von [adoptium.net](https://adoptium.net/) herunterladen.
...
```java
BACKGROUND_COLOR  = #191923  // Tiefdunkler Hintergrund
...
*Erstellt mit ❤️ für alle, die Matrizen meistern wollen.*
